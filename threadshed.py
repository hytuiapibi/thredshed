...
for item in sales:
   stripped = item.strip("$")
   total_sales += float(stripped)

print("Total sales for today: $",total_sales)
#--- Number of each color thread sold ---#
...
for color in colors:
  print("Thread Shed sold {} threads of {} thread today."
